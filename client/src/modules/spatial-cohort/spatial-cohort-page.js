          ...
          <Card.Body
            ...
            <ErrorBoundary
              ...
              <Suspense fallback={<Loader message="Loading Plots" />}>
                {/* the sticky control bar (filters + the cohort title/sample
                    count header) is rendered by the plots module — the header
                    reads live state only the fetch-mode components have */}
                <SpatialCohortPlots />
              </Suspense>
            </ErrorBoundary>
          </Card.Body>
